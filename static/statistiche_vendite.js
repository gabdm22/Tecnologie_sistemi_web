document.addEventListener('DOMContentLoaded', function(){
    const prezzi = document.querySelectorAll('.prezzo-pagato-vendita');
    let somma = 0;
    ...
    document.getElementById('numero-opere-vendute').innerText = prezzi.length;

    const display_tot = document.getElementById('totale-vendite');
